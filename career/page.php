...
<head prefix="og: http://ogp.me/ns#">
	...
	<!-- Website SEO -->
	<title>ক্যারিয়ার -সংবাদ-পাতা-<?php echo pagenum($page); ?>- বোধিধারা</title>
	<meta name="keywords" content="ক্যারিয়ার, ক্যারিয়ার খবর, সূত্র পিটক,বিনয় পিটক, অভিধর্ম পিটক, বনভন্তের দেশনা, বাংলায় সমগ্র ক্যারিয়ার, ত্রিশরণ ফাউন্ডেশন অব বাংলাদেশ, চাকমা,আমেরিকা,ভারত,মায়ানমার,শ্রীলংকা,কম্বোডিয়া,তিব্বত, আদিবাসী, পার্বত্য চট্টগ্রামের বৌদ্ধ, প্রতিরূপ দেশ, বৌদ্ধ খবর, ক্যারিয়ার বৌদ্ধ খবর , বৌদ্ধ রাষ্ট্র,  বৌদ্ধ ভিক্ষু,বনভন্তে,রাজবনবিহার,জাতক সমগ্র, বিশুদ্ধি মার্গ">
	...
	<!--for fb -->
	<meta property="og:title" content="ক্যারিয়ার -সংবাদ-পাতা-<?php echo pagenum($page); ?>- বোধিধারা">
	<meta property="og:site_name" content="বোধিধারা">
	<meta property="og:description" content="ক্যারিয়ার খবর - বৌদ্ধ রাষ্ট্র, বৌদ্ধ খবর ও বিশ্বের বৌদ্ধ ধর্মের অবদান। ক্যারিয়ার , বৌদ্ধ শিক্ষা, বৌদ্ধ বার্তা, বৌদ্ধ মনন">
	<meta property="og:type" content="website">
	<meta property="og:url" content="/career/page/<?php echo $page; ?>">
	...
	<link rel="stylesheet" href="/career/link/page.css"/>
</head>
<body>
	...
	<section class="container"> 
		...
		<div class="breadcrumb"> 
			<ul>
				<li class="breadcrumb-item bred"> <a href="/career"></a> </li>
				<li class="breadcrumb-item bred"> <a href="/career">ক্যারিয়ার</a> </li>
				<li class="breadcrumb-item"> <a href="career/page/<?php echo $page; ?>">পাতা-<?php echo pagenum($page); ?></a> </li>
			</ul>
		</div>
		<div class="row"> 
			<div class="col-md-8 col-12">
				<h4 class="titlebar">ক্যারিয়ার-সংবাদ-পাতা-<?php echo pagenum($page); ?></h4>
				<div class="page-view-news"> 
					<?php
					$per_page = 8;
					$start_form = ($page-1) * $per_page;
					$sql = "SELECT * FROM bodhi_news WHERE category='career' ORDER BY id DESC limit $start_form, $per_page";
				...
				<div class="paginations">
					...
					if($total_pages == $page){?>
						<a class="previous-page" href="/career/page/<?php echo $page-1; ?>"><span>&lt; &lt; </span></a>
					<?php }elseif($page == 1){ ?>
						<a class="next-page" href="/career/page/<?php echo $page+1; ?>"><span>&gt; &gt; </span></a>
					<?php }else{
						?>
						<a class="previous-page" href="/career/page/<?php echo $page-1; ?>"><span>&lt; &lt; </span></a>
						<a class="next-page" href="/career/page/<?php echo $page+1; ?>"><span>&gt; &gt; </span></a>
			...
			<div class="col-md-4 col-12 page-other"> 
				<div class="page-other-news"> 
					<h2 class="title-bar">ক্যারিয়ার</h2>
					<div class="row"> 
						<?php
						$sql = "SELECT * FROM bodhi_news WHERE category='career' ORDER BY id DESC limit 4";
						$result = mysqli_query($conn,$sql);
						while($view = mysqli_fetch_assoc($result)){?>
