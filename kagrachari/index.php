...
<head prefix="og: https://ogp.me/ns#">
	...
	<!-- Website SEO -->
	<title>খাগরাছড়ি খবর - বোধিধারা</title>
	<meta name="keywords" content="খাগরাছড়ি, খাগরাছড়ি খবর, পানছড়ি,দীঘিনালা, মহালছড়ি, লক্ষ্ণীছড়ি, মাটিরাঙ্গা, ত্রিশরণ ফাউন্ডেশন অব বাংলাদেশ, চাকমা,রামঘর,মানিকছড়ি, আদিবাসী, পার্বত্য চট্টগ্রামের বৌদ্ধ, প্রতিরূপ দেশ, বৌদ্ধ খবর, খাগরাছড়ি বৌদ্ধ খবর , বৌদ্ধ রাষ্ট্র,  বৌদ্ধ ভিক্ষু,বনভন্তে,রাজবনবিহার,জাতক সমগ্র, বিশুদ্ধি মার্গ">
	<meta name="description" content="খাগরাছড়ি খবর -  খাগড়াছড়ি জেলার খবর, উপজেলার খবর,  পানছড়ি উপজেলার খবর, মহালছড়ি উপজেলার খবর, লক্ষ্ণীছড়ি উপজেলার খবর, মাটিরাঙ্গা উপজেলার খবর, দীঘিনালা উপজেলার খবর পড়ুন বোধিধারা পত্রিকায়">
	<!--for fb -->
	<meta property="og:title" content="খাগরাছড়ি খবর - বোধিধারা">
	<meta property="og:site_name" content="বোধিধারা">
	<meta property="og:description" content="খাগরাছড়ি খবর -  খাগড়াছড়ি জেলার খবর, উপজেলার খবর,  পানছড়ি উপজেলার খবর, মহালছড়ি উপজেলার খবর, লক্ষ্ণীছড়ি উপজেলার খবর, মাটিরাঙ্গা উপজেলার খবর, দীঘিনালা উপজেলার খবর পড়ুন বোধিধারা পত্রিকায়">
	<meta property="og:type" content="website">
	<meta property="og:url" content="/kagrachari">
		...
		<section class="section"> 
			...
			<div class="breadcrumb"> 
				<ul>
					...
					<li class="breadcrumb-item"> <a href="/kagrachari">খাগড়াছড়ি</a> </li>
				</ul>
			</div>
			<div class="row main-news-section">
				<div class="col-md-6 news"><!-- kagrachari Main News-->
					<?php
						$sql = "SELECT * FROM bodhi_news WHERE category='kagrachari' ORDER BY id DESC limit 1";
						$result = mysqli_query($conn, $sql);
						while($view = mysqli_fetch_assoc($result)){
					?>
					<div class="main-news">
						<a href="kagrachari/article/<?php echo $view["selNo"]; ?>/<?php echo slugTitle($view["title"]); ?>">
							<div class="image"> 
								<span
				...
				<?php
					$a = "SELECT * FROM bodhi_news WHERE category='kagrachari' ORDER BY id DESC limit 3";
					...
					$row3 = $array[3];
				?>
				<div class="col-md-3 news-sub"><!-- kagrachari Sub News -->
				<?php
				$sql = "SELECT * FROM bodhi_news WHERE category='kagrachari' AND id IN ('$row2','$row3') ORDER BY id DESC";
				$result = mysqli_query($conn, $sql);
				while($view = mysqli_fetch_assoc($result)){
				?>
			...
			<div class="row news-relate"><!-- kagrachari News Relate -->
				<?php
					$a = "SELECT * FROM bodhi_news WHERE category='kagrachari' ORDER BY id DESC limit 11";
					$b = mysqli_query($conn, $a);
					$x = 1;
					while($c = mysqli_fetch_assoc($b)){
						$y = $x++;
				...
				?>
				<?php
					$sql = "SELECT * FROM bodhi_news WHERE category='kagrachari' AND id IN ('$row4','$row5','$row6','$row7','$row8','$row9','$row10','$row11') ORDER BY id DESC";
					$result = mysqli_query($conn, $sql);
					while($view = mysqli_fetch_assoc($result)){
				?>
			...
			<div class="row"> 
				<div class="col-md-8 col-12 new-col"> 
					<div class="last-news-one"> 
						...
						<?php
						$a = "SELECT * FROM bodhi_news WHERE category='kagrachari' ORDER BY id DESC limit 14";
						$b = mysqli_query($conn, $a);
						$x = 1;
						while($c = mysqli_fetch_assoc($b)){
							$y = $x++;
						...
						?>
						<?php
							$sql = "SELECT * FROM bodhi_news WHERE category='kagrachari' AND id IN ('$row12','$row13','$row14') ORDER BY id DESC";
							$result = mysqli_query($conn, $sql);
							while($view = mysqli_fetch_assoc($result)){
						?>
						<div class="last-news"> 
					...
					<div class="last-news-two"> 
						<?php
						$a = "SELECT * FROM bodhi_news WHERE category='kagrachari' ORDER BY id DESC limit 18";
						$b = mysqli_query($conn, $a);
						$x = 1;
						while($c = mysqli_fetch_assoc($b)){
							$y = $x++;
						...
						?>
						<?php
							$sql = "SELECT * FROM bodhi_news WHERE category='kagrachari' AND id IN ('$row15','$row16','$row17','$row18') ORDER BY id DESC";
							$result = mysqli_query($conn, $sql);
							while($view = mysqli_fetch_assoc($result)){
						?>
						<div class="last-news"> 
					...
					<div class="last-news-three"> 
						<?php
						$a = "SELECT * FROM bodhi_news WHERE category='kagrachari' ORDER BY id DESC limit 21";
						$b = mysqli_query($conn, $a);
						$x = 1;
						while($c = mysqli_fetch_assoc($b)){
							$y = $x++;
						...
						?>
						<?php
							$sql = "SELECT * FROM bodhi_news WHERE category='kagrachari' AND id IN ('$row19','$row20','$row21') ORDER BY id DESC";
							$result = mysqli_query($conn, $sql);
							while($view = mysqli_fetch_assoc($result)){
						?>
						<div class="last-news"> 
					...
					<?php 
					$sql = "SELECT * FROM bodhi_news WHERE category='kagrachari'";
					$result = mysqli_query($conn, $sql);
					$rows = mysqli_num_rows($result);
					if($rows > 21){
					?>
					<div class="bottom">
						<a class="more-link" href="/kagrachari/page.php?page=2">আরও</a>
					</div>
					<?php } ?>
				</div>
