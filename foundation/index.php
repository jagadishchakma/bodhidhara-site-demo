...
<head prefix="og: https://ogp.me/ns#">
	...
	<!-- Website SEO -->
	<title>ত্রিশরণ ফাউন্ডেশন  খবর - বোধিধারা</title>
	<meta name="keywords" content="ত্রিশরণ ফাউন্ডেশন , CHT Organizations, বৌদ্ধ ধর্মীয় সংস্থা, আদিবাসী, পার্বত্য চট্টগ্রামের বৌদ্ধ, প্রতিরূপ দেশ, বৌদ্ধ খবর, ত্রিশরণ ফাউন্ডেশন  বৌদ্ধ খবর , বৌদ্ধ রাষ্ট্র,  বৌদ্ধ ভিক্ষু,বনভন্তে,রাজবনবিহার,জাতক সমগ্র, বিশুদ্ধি মার্গ">
	<meta name="description" content="ত্রিশরণ ফাউন্ডেশন  খবর - TFB Chakma Buddhist Foundations, CHT Free Foundation, Bodhidhara newspaper, Trisoron Foundation of Bangladesh, Donations">
	<!--for fb -->
	<meta property="og:title" content="ত্রিশরণ ফাউন্ডেশন  খবর - বোধিধারা">
	<meta property="og:site_name" content="বোধিধারা">
	<meta property="og:description" content="ত্রিশরণ ফাউন্ডেশন  খবর - TFB Chakma Buddhist Foundations, CHT Free Foundation, Bodhidhara newspaper, Trisoron Foundation of Bangladesh, Donations">
	...
	<link rel="stylesheet" href="/foundation/link/style.css"/>
</head>
<body>
		...
		<section class="section"> 
			...
			<div class="breadcrumb"> 
				<ul>
					...
					<li class="breadcrumb-item"> <a href="/foundation">ত্রিশরণ ফাউন্ডেশন</a> </li>
				</ul>
			</div>
			<div class="row main-news-section">
				<div class="col-md-6 news"><!-- foundation Main News-->
					<?php
						$sql = "SELECT * FROM bodhi_news WHERE category='foundation' ORDER BY id DESC limit 1";
						$result = mysqli_query($conn, $sql);
						while($view = mysqli_fetch_assoc($result)){
					?>
					<div class="main-news">
						<a href="foundation/article/<?php echo $view["selNo"]; ?>/<?php echo slugTitle($view["title"]); ?>">
							<div class="image"> 
								<span
				...
				<?php
					$a = "SELECT * FROM bodhi_news WHERE category='foundation' ORDER BY id DESC limit 3";
					...
					$row3 = $array[3];
				?>
				<div class="col-md-3 news-sub"><!-- foundation Sub News -->
				<?php
				$sql = "SELECT * FROM bodhi_news WHERE category='foundation' AND id IN ('$row2','$row3') ORDER BY id DESC";
				$result = mysqli_query($conn, $sql);
				while($view = mysqli_fetch_assoc($result)){
				?>
			...
			<div class="row news-relate"><!-- foundation News Relate -->
				<?php
					$a = "SELECT * FROM bodhi_news WHERE category='foundation' ORDER BY id DESC limit 11";
					$b = mysqli_query($conn, $a);
					$x = 1;
					while($c = mysqli_fetch_assoc($b)){
						$y = $x++;
				...
				?>
				<?php
					$sql = "SELECT * FROM bodhi_news WHERE category='foundation' AND id IN ('$row4','$row5','$row6','$row7','$row8','$row9','$row10','$row11') ORDER BY id DESC";
					$result = mysqli_query($conn, $sql);
					while($view = mysqli_fetch_assoc($result)){
				?>
				<div class="col-md-3 col-6 news"> 
					<div class="each-news"> 
						<a class="news-link-overly" href="/foundation/article/<?php echo $view["selNo"]; ?>/<?php echo slugTitle($view["title"]); ?>"> 
							<div class="image"> 
								<span
								   class="lazy-image out"
								   data-class="big-img"
			...
			<div class="row"> 
				<div class="col-md-8 col-12 new-col"> 
					<div class="last-news-one"> 
						...
						<?php
						$a = "SELECT * FROM bodhi_news WHERE category='foundation' ORDER BY id DESC limit 14";
						$b = mysqli_query($conn, $a);
						$x = 1;
						while($c = mysqli_fetch_assoc($b)){
							$y = $x++;
						...
						?>
						<?php
							$sql = "SELECT * FROM bodhi_news WHERE category='foundation' AND id IN ('$row12','$row13','$row14') ORDER BY id DESC";
							$result = mysqli_query($conn, $sql);
							while($view = mysqli_fetch_assoc($result)){
						?>
						<div class="last-news"> 
					...
					<div class="last-news-two"> 
						<?php
						$a = "SELECT * FROM bodhi_news WHERE category='foundation' ORDER BY id DESC limit 18";
						$b = mysqli_query($conn, $a);
						$x = 1;
						while($c = mysqli_fetch_assoc($b)){
							$y = $x++;
						...
						?>
						<?php
							$sql = "SELECT * FROM bodhi_news WHERE category='foundation' AND id IN ('$row15','$row16','$row17','$row18') ORDER BY id DESC";
							$result = mysqli_query($conn, $sql);
							while($view = mysqli_fetch_assoc($result)){
						?>
						<div class="last-news"> 
					...
					<div class="last-news-three"> 
						<?php
						$a = "SELECT * FROM bodhi_news WHERE category='foundation' ORDER BY id DESC limit 21";
						$b = mysqli_query($conn, $a);
						$x = 1;
						while($c = mysqli_fetch_assoc($b)){
							$y = $x++;
						...
						?>
						<?php
							$sql = "SELECT * FROM bodhi_news WHERE category='foundation' AND id IN ('$row19','$row20','$row21') ORDER BY id DESC";
							$result = mysqli_query($conn, $sql);
							while($view = mysqli_fetch_assoc($result)){
						?>
						<div class="last-news"> 
					...
					<?php 
					$sql = "SELECT * FROM bodhi_news WHERE category='foundation'";
					$result = mysqli_query($conn, $sql);
					$rows = mysqli_num_rows($result);
					if($rows > 21){
					?>
					<div class="bottom">
						<a class="more-link" href="/foundation/page.php?page=2">আরও</a>
					</div>
					<?php } ?>
				</div>
