...
<head prefix="og: http://ogp.me/ns#">
	...
	<!-- Website SEO -->
	<title>বিজ্ঞাপন -সংবাদ-পাতা-<?php echo pagenum($page); ?>- বোধিধারা</title>
	...
	<!--for fb -->
	<meta property="og:title" content="বিজ্ঞাপন -সংবাদ-পাতা-<?php echo pagenum($page); ?>- বোধিধারা">
	<meta property="og:site_name" content="বোধিধারা">
	<meta property="og:description" content="বিজ্ঞাপন খবর - বৌদ্ধ রাষ্ট্র, বৌদ্ধ খবর ও বিশ্বের বৌদ্ধ ধর্মের অবদান। বিজ্ঞাপন , বৌদ্ধ শিক্ষা, বৌদ্ধ বার্তা, বৌদ্ধ মনন">
	<meta property="og:type" content="website">
	<meta property="og:url" content="https://www.bodhidhara.com/advertisement/page/<?php echo $page; ?>">
	...
	<link rel="stylesheet" href="/advertisement/link/page.css"/>
</head>
<body>
	...
	<section class="container"> 
		...
		<div class="breadcrumb"> 
			<ul>
				<li class="breadcrumb-item bred"> <a href="https://www.bodhidhara.com/advertisement"></a> </li>
				<li class="breadcrumb-item bred"> <a href="https://www.bodhidhara.com/advertisement">বিজ্ঞাপন</a> </li>
				<li class="breadcrumb-item"> <a href="advertisement/page/<?php echo $page; ?>">পাতা-<?php echo pagenum($page); ?></a> </li>
			</ul>
		</div>
		<div class="row"> 
			<div class="col-md-8 col-12">
				<h4 class="titlebar">বিজ্ঞাপন-সংবাদ-পাতা-<?php echo pagenum($page); ?></h4>
				<div class="page-view-news"> 
					<?php
					$per_page = 8;
					$start_form = ($page-1) * $per_page;
					$sql = "SELECT * FROM bodhi_ads ORDER BY id DESC limit $start_form, $per_page";
				...
				<div class="paginations">
					...
					if($total_pages == $page){?>
						<a class="previous-page" href="/advertisement/page/<?php echo $page-1; ?>"><span>&lt; &lt; </span></a>
					<?php }elseif($page == 1){ ?>
						<a class="next-page" href="/advertisement/page/<?php echo $page+1; ?>"><span>&gt; &gt; </span></a>
					<?php }else{
						?>
						<a class="previous-page" href="/advertisement/page/<?php echo $page-1; ?>"><span>&lt; &lt; </span></a>
						<a class="next-page" href="/advertisement/page/<?php echo $page+1; ?>"><span>&gt; &gt; </span></a>
			...
			<div class="col-md-4 col-12 page-other"> 
				<div class="page-other-news"> 
					<h2 class="title-bar">অন্যান্য</h2>
					<div class="row"> 
						<?php
						$sql = "SELECT * FROM bodhi_news  ORDER BY title DESC limit 4";
						$result = mysqli_query($conn,$sql);
						while($view = mysqli_fetch_assoc($result)){?>
