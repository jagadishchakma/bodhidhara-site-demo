...
function sub_category($subcategory){
	$sub = $subcategory;
	$engsub = array("culture1","culture2","culture3","culture4","culture5","culture6","culture7","culture8","culture9","culture10");
	$bnsub = array("চাকমা","মারমা","ত্রিপুরা","আদিবাসী","বৈসাবি","পুরনো দিন","পজ্জম","বানা","ভাষা","শিল্প");
...
<head prefix="og: http://ogp.me/ns#">
	...
	<link rel="stylesheet" href="/culture/link/article.css"/>
</head>
<body>
	...
	<section class="section container"> 
		...
		<div class="breadcrumb"> 
			<ul>
				...
				<li class="breadcrumb-item"><a href="/culture"><?php echo sub_category($view["subcategory"]); ?></a> </li>
			</ul>
		</div>
		<div class="row"> 
			<div class="col-md-8 col-12"> 
				<div class="row"> 
					<div class="left-category"> 
						<div class="col-in"><a href="/culture"> সংস্কৃতি সংবাদ</a></div>
					</div>
				...
				<div class="row detail-holder"> 
					...
					<div class="right-part">
						<div class="col-in"> 
							...
							<div class="more-tag">
								<a class="more-link" href="/culture/page/2">আরও সংবাদ</a>
								<?php 
								$id = $view["id"]-1;
								$limit = $id-100;
								$sql = "SELECT * FROM bodhi_news WHERE category='culture' AND id BETWEEN $limit AND $id ORDER BY id DESC limit 1";
								$result = mysqli_query($conn, $sql);
								$left = mysqli_fetch_assoc($result);
								?>
								<a class="more-link" href="/culture/article/<?php echo $left["selNo"]; ?>/<?php echo slugTitle($left["title"]); ?>">আগের সংবাদ</a>
								<?php 
								$id = $view["id"]+1;
								$limit = $id+100;
								$sql = "SELECT * FROM bodhi_news WHERE category='culture' AND id BETWEEN $id AND $limit ORDER BY id ASC limit 1";
								$result = mysqli_query($conn, $sql);
								$right = mysqli_fetch_assoc($result);
								?>
								<a class="more-link" href="/culture/article/<?php echo $right["selNo"]; ?>/<?php echo slugTitle($right["title"]); ?>">পরের সংবাদ</a>
							</div>
			...
			<div class="col-md-4 col-12"> 
				<div class="o-r-news"> 
					<?php 
					$sql = "SELECT * FROM bodhi_news WHERE category='culture' ORDER BY id DESC limit 8";
					$result = mysqli_query($conn, $sql);
	...
	<div class="content-next-prev"> 
		<div class="prev content-holder"> 
			...
			<div class="content-inner"> 
				<div class="contents"> 
					<div class="each"> 
						<a class="prev-next-link" href="/culture/article/<?php echo $left["selNo"]; ?>/<?php echo slugTitle($left["title"]); ?>"></a>
						<div class="image"> 
		...
		<div class="content-holder next"> 
			...
			<div class="content-inner"> 
				<div class="contents"> 
					<div class="each"> 
						<a class="prev-next-link" href="/culture/article/<?php echo $right["selNo"]; ?>/<?php echo slugTitle($right["title"]); ?>"></a>
						<div class="image"> 
