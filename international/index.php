...
<head prefix="og: https://ogp.me/ns#">
	...
	<!-- Website SEO -->
	<title>আন্তর্জাতিক খবর - বোধিধারা</title>
	...
	<!--for fb -->
	<meta property="og:title" content="আন্তর্জাতিক খবর - বোধিধারা">
		...
		<section class="section"> 
			...
			<div class="breadcrumb"> 
				<ul>
					...
					<li class="breadcrumb-item"> <a href="/international">আন্তর্জাতিক</a> </li>
				</ul>
			</div>
			<div class="row main-news-section">
				<div class="col-md-6 news"><!-- international Main News-->
					<?php
						$sql = "SELECT * FROM bodhi_news WHERE category='international' ORDER BY id DESC limit 1";
						$result = mysqli_query($conn, $sql);
						while($view = mysqli_fetch_assoc($result)){
					?>
					<div class="main-news">
						<a href="international/article/<?php echo $view["selNo"]; ?>/<?php echo slugTitle($view["title"]); ?>">
							<div class="image"> 
								<span
				...
				<?php
					$a = "SELECT * FROM bodhi_news WHERE category='international' ORDER BY id DESC limit 3";
					...
					$row3 = $array[3];
				?>
				<div class="col-md-3 news-sub"><!-- international Sub News -->
				<?php
				$sql = "SELECT * FROM bodhi_news WHERE category='international' AND id IN ('$row2','$row3') ORDER BY id DESC";
				$result = mysqli_query($conn, $sql);
				while($view = mysqli_fetch_assoc($result)){
				?>
			...
			<div class="row news-relate"><!-- international News Relate -->
				<?php
					$a = "SELECT * FROM bodhi_news WHERE category='international' ORDER BY id DESC limit 11";
					$b = mysqli_query($conn, $a);
					$x = 1;
					while($c = mysqli_fetch_assoc($b)){
						$y = $x++;
				...
				?>
				<?php
					$sql = "SELECT * FROM bodhi_news WHERE category='international' AND id IN ('$row4','$row5','$row6','$row7','$row8','$row9','$row10','$row11') ORDER BY id DESC";
					$result = mysqli_query($conn, $sql);
					while($view = mysqli_fetch_assoc($result)){
				?>
			...
			<div class="row"> 
				<div class="col-md-8 col-12 new-col"> 
					<div class="last-news-one"> 
						...
						<?php
						$a = "SELECT * FROM bodhi_news WHERE category='international' ORDER BY id DESC limit 14";
						$b = mysqli_query($conn, $a);
						$x = 1;
						while($c = mysqli_fetch_assoc($b)){
							$y = $x++;
						...
						?>
						<?php
							$sql = "SELECT * FROM bodhi_news WHERE category='international' AND id IN ('$row12','$row13','$row14') ORDER BY id DESC";
							$result = mysqli_query($conn, $sql);
							while($view = mysqli_fetch_assoc($result)){
						?>
						<div class="last-news"> 
					...
					<div class="last-news-two"> 
						<?php
						$a = "SELECT * FROM bodhi_news WHERE category='international' ORDER BY id DESC limit 18";
						$b = mysqli_query($conn, $a);
						$x = 1;
						while($c = mysqli_fetch_assoc($b)){
							$y = $x++;
						...
						?>
						<?php
							$sql = "SELECT * FROM bodhi_news WHERE category='international' AND id IN ('$row15','$row16','$row17','$row18') ORDER BY id DESC";
							$result = mysqli_query($conn, $sql);
							while($view = mysqli_fetch_assoc($result)){
						?>
						<div class="last-news"> 
					...
					<div class="last-news-three"> 
						<?php
						$a = "SELECT * FROM bodhi_news WHERE category='international' ORDER BY id DESC limit 21";
						$b = mysqli_query($conn, $a);
						$x = 1;
						while($c = mysqli_fetch_assoc($b)){
							$y = $x++;
						...
						?>
						<?php
							$sql = "SELECT * FROM bodhi_news WHERE category='international' AND id IN ('$row19','$row20','$row21') ORDER BY id DESC";
							$result = mysqli_query($conn, $sql);
							while($view = mysqli_fetch_assoc($result)){
						?>
						<div class="last-news"> 
					...
					?>
					<div class="bottom">
						<a class="more-link" href="/international/page.php?page=2">আরও</a>
					</div>
					<?php } ?>
				</div>
