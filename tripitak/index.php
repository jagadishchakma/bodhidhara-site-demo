...
<head prefix="og: https://ogp.me/ns#">
	...
	<!-- Website SEO -->
	<title>ত্রিপিটক খবর - বোধিধারা</title>
	...
	<!--for fb -->
	<meta property="og:title" content="ত্রিপিটক খবর - বোধিধারা">
	<meta property="og:site_name" content="বোধিধারা">
	<meta property="og:description" content="ত্রিপিটক খবর - বৌদ্ধ রাষ্ট্র,জাপান, বৌদ্ধ খবর ও বিশ্বের বৌদ্ধ ধর্মের অবদান। ত্রিপিটক , বৌদ্ধ শিক্ষা, বৌদ্ধ বার্তা, বৌদ্ধ মনন, বাংলায় সমগ্র ত্রিপিটক প্রকাশ, বিনয় পিটক, সূত্র পিটক, অভিধর্ম পিটক">
	<meta property="og:type" content="website">
	<meta property="og:url" content="/tripitak">
		...
		<section class="section"> 
			...
			<div class="breadcrumb"> 
				<ul>
					...
					<li class="breadcrumb-item"> <a href="/tripitak">ত্রিপিটক</a> </li>
				</ul>
			</div>
			<div class="row main-news-section">
				<div class="col-md-6 news"><!-- tripitak Main News-->
					<?php
						$sql = "SELECT * FROM bodhi_news WHERE category='tripitak' ORDER BY id DESC limit 1";
						$result = mysqli_query($conn, $sql);
						while($view = mysqli_fetch_assoc($result)){
					?>
					<div class="main-news">
						<a href="tripitak/article/<?php echo $view["selNo"]; ?>/<?php echo slugTitle($view["title"]); ?>">
							<div class="image"> 
								<span
				...
				<?php
					$a = "SELECT * FROM bodhi_news WHERE category='tripitak' ORDER BY id DESC limit 3";
					...
					$row3 = $array[3];
				?>
				<div class="col-md-3 news-sub"><!-- tripitak Sub News -->
				<?php
				$sql = "SELECT * FROM bodhi_news WHERE category='tripitak' AND id IN ('$row2','$row3') ORDER BY id DESC";
				$result = mysqli_query($conn, $sql);
				while($view = mysqli_fetch_assoc($result)){
				?>
			...
			<div class="row news-relate"><!-- tripitak News Relate -->
				<?php
					$a = "SELECT * FROM bodhi_news WHERE category='tripitak' ORDER BY id DESC limit 11";
					$b = mysqli_query($conn, $a);
					$x = 1;
					while($c = mysqli_fetch_assoc($b)){
						$y = $x++;
				...
				?>
				<?php
					$sql = "SELECT * FROM bodhi_news WHERE category='tripitak' AND id IN ('$row4','$row5','$row6','$row7','$row8','$row9','$row10','$row11') ORDER BY id DESC";
					$result = mysqli_query($conn, $sql);
					while($view = mysqli_fetch_assoc($result)){
				?>
			...
			<div class="row"> 
				<div class="col-md-8 col-12 new-col"> 
					<div class="last-news-one"> 
						...
						<?php
						$a = "SELECT * FROM bodhi_news WHERE category='tripitak' ORDER BY id DESC limit 14";
						$b = mysqli_query($conn, $a);
						$x = 1;
						while($c = mysqli_fetch_assoc($b)){
							$y = $x++;
						...
						?>
						<?php
							$sql = "SELECT * FROM bodhi_news WHERE category='tripitak' AND id IN ('$row12','$row13','$row14') ORDER BY id DESC";
							$result = mysqli_query($conn, $sql);
							while($view = mysqli_fetch_assoc($result)){
						?>
						<div class="last-news"> 
					...
					<div class="last-news-two"> 
						<?php
						$a = "SELECT * FROM bodhi_news WHERE category='tripitak' ORDER BY id DESC limit 18";
						$b = mysqli_query($conn, $a);
						$x = 1;
						while($c = mysqli_fetch_assoc($b)){
							$y = $x++;
						...
						?>
						<?php
							$sql = "SELECT * FROM bodhi_news WHERE category='tripitak' AND id IN ('$row15','$row16','$row17','$row18') ORDER BY id DESC";
							$result = mysqli_query($conn, $sql);
							while($view = mysqli_fetch_assoc($result)){
						?>
						<div class="last-news"> 
					...
					<div class="last-news-three"> 
						<?php
						$a = "SELECT * FROM bodhi_news WHERE category='tripitak' ORDER BY id DESC limit 21";
						$b = mysqli_query($conn, $a);
						$x = 1;
						while($c = mysqli_fetch_assoc($b)){
							$y = $x++;
						...
						?>
						<?php
							$sql = "SELECT * FROM bodhi_news WHERE category='tripitak' AND id IN ('$row19','$row20','$row21') ORDER BY id DESC";
							$result = mysqli_query($conn, $sql);
							while($view = mysqli_fetch_assoc($result)){
						?>
						<div class="last-news"> 
					...
					?>
					<div class="bottom">
						<a class="more-link" href="/tripitak/page.php?page=2">আরও</a>
					</div>
					<?php } ?>
				</div>
