...
<body>
			...
			<ul>
				...
				<li><span class="glyphicon glyphicon-paperclip"></span> E-paper Post
					<ul>
						...
						<li><a href="e-post.php?post5=news_detail">News Detail Post</a></li>
					</ul>
				</li>
	...
	<section class="section"> 
		<div class="rules"> 
			...
			<p> 
				<ul>
					<li><b>Bodhi Category Post:</b> এখানে বোধিধারার পোস্টগুলি দেওয়া হয়।</li>
					<li><b>Bodhi Voting Post:</b> এখানে গিয়ে ভোট গ্রহণ নির্বাচন পোস্ট করা হয়। </li>
					<li><b>Bodhi Ads Post:</b> এখানে গিয়ে  বিজ্ঞাপন দেওয়া হয়।</li>
					<li><b>Bodhi Video Upload:</b> এখানে ইউটিউভ এর ভিডিও লিংক শেয়ার করা হয়।</li>
					<li><b>Bodhi Photo Upload:</b> এখানে গিয়ে ফটো এ্যালবাম আপলোড করা হয়।</li>
				</ul>
			</p>
			<hr/>
			<p>
				<ul>
					<li><b>Bodhi Category Edit: </b> এখানে বোধিধারা পেজ এর পোস্টগুলি Edit করা হয়।</li>
					<li><b>Bodhi Voting Edit: </b> এখানে বোধিধারা পেজ ভোট এর পোস্টগুলি Edit করা হয়।</li>
					<li><b>Bodhi Ads Edit: </b> এখানে বিজ্ঞাপন পেজ এর পোস্টগুলি Edit করা হয়।</li>
					<li><b>Bodhi Video Edit: </b> এখানে ভিডিও পেজ এর পোস্টগুলি Edit করা হয়।</li>
					<li><b>Bodhi Photo  Edit: </b> এখানে ফটো পেজ এর পোস্টগুলি Edit করা হয়।</li>
				</ul>
			</p>
		</div>
	</section>
