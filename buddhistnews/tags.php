...
if($tag == "katina-cibor-dan"){
	$subcategory = "buddhistnews8";
	$sql = "SELECT * FROM bodhi_news WHERE category='buddhistnews' AND subcategory='$subcategory' ORDER BY id DESC limit 1";
...
<head prefix="og: http://ogp.me/ns#">
	...
	<!-- Website SEO -->
	<title>বৌদ্ধবার্তা - <?php echo sub_category($subcategory); ?>- বোধিধারা</title>
	...
	<section class="container"> 
		...
		<div class="breadcrumb"> 
			<ul>
				...
				<li class="breadcrumb-item"> <a href="/buddhistnews/<?php echo sub_category($subcategory); ?>/1"><?php echo sub_category($subcategory); ?></a> </li>
			</ul>
		</div>
		<div class="row"> 
			<div class="col-md-8 col-12">
				<h4 class="titlebar">বৌদ্ধবার্তা-<?php echo sub_category($subcategory); ?></h4>
				<div class="page-view-news"> 
					<?php
					$per_page = 8;
					$start_form = ($page-1) * $per_page;
					$sql = "SELECT * FROM bodhi_news WHERE category='buddhistnews' AND subcategory='$subcategory' ORDER BY id DESC limit $start_form, $per_page";
					$result = mysqli_query($conn,$sql);
				...
				<div class="paginations">
					<?php
					error_reporting(0);
					$sql = "SELECT * FROM bodhi_news WHERE category='buddhistnews' AND subcategory='$subcategory";
					$result = mysqli_query($conn, $sql);
