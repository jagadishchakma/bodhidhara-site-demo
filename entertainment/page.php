...
<head prefix="og: http://ogp.me/ns#">
	...
	<!-- Website SEO -->
	<title>বিনোদন -সংবাদ-পাতা-<?php echo pagenum($page); ?>- বোধিধারা</title>
	...
	<!--for fb -->
	<meta property="og:title" content="বিনোদন -সংবাদ-পাতা-<?php echo pagenum($page); ?>- বোধিধারা">
	...
	<meta property="og:url" content="/entertainment/page/<?php echo $page; ?>">
	...
	<link rel="stylesheet" href="/entertainment/link/page.css"/>
</head>
<body>
	...
	<section class="container"> 
		...
		<div class="breadcrumb"> 
			<ul>
				<li class="breadcrumb-item bred"> <a href="/entertainment"></a> </li>
				<li class="breadcrumb-item bred"> <a href="/entertainment">বিনোদন</a> </li>
				<li class="breadcrumb-item"> <a href="entertainment/page/<?php echo $page; ?>">পাতা-<?php echo pagenum($page); ?></a> </li>
			</ul>
		</div>
		<div class="row"> 
			<div class="col-md-8 col-12">
				<h4 class="titlebar">বিনোদন-সংবাদ-পাতা-<?php echo pagenum($page); ?></h4>
				<div class="page-view-news"> 
					<?php
					$per_page = 8;
					$start_form = ($page-1) * $per_page;
					$sql = "SELECT * FROM bodhi_news WHERE category='entertainment' ORDER BY id DESC limit $start_form, $per_page";
				...
				<div class="paginations">
					...
					if($total_pages == $page){?>
						<a class="previous-page" href="/entertainment/page/<?php echo $page-1; ?>"><span>&lt; &lt; </span></a>
					<?php }elseif($page == 1){ ?>
						<a class="next-page" href="/entertainment/page/<?php echo $page+1; ?>"><span>&gt; &gt; </span></a>
					<?php }else{
						?>
						<a class="previous-page" href="/entertainment/page/<?php echo $page-1; ?>"><span>&lt; &lt; </span></a>
						<a class="next-page" href="/entertainment/page/<?php echo $page+1; ?>"><span>&gt; &gt; </span></a>
			...
			<div class="col-md-4 col-12 page-other"> 
				<div class="page-other-news"> 
					<h2 class="title-bar">বিনোদন</h2>
					<div class="row"> 
						<?php
						$sql = "SELECT * FROM bodhi_news WHERE category='entertainment' ORDER BY id DESC limit 4";
						$result = mysqli_query($conn,$sql);
						while($view = mysqli_fetch_assoc($result)){?>
